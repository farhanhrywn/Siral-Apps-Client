...
const DashboardV1 = React.lazy(() => import('./views/dashboard/DashboardV1'));
...
const Registrasi = React.lazy(() => import('./views/users/Registrasi'));
...
const routes = [
  ...
  { path: '/dashboard', name: 'Dashboard', component: DashboardV1 },
  { path: '/daftar', name: 'Daftar', component: Dashboard },
  { path: '/registrasi', name: 'Registrasi', component: Registrasi },
  { path: '/report', name: 'Report', component: Report },
  { path: '/add', name: 'Add Admin', component: AddAdmin },
